  ...
  return (
    <section className="relative py-24">
      ...
      <div className="relative mx-auto max-w-7xl px-4 md:px-6">
        <Reveal>
          <div className="grid gap-8 rounded-[36px] border border-sky-100 bg-white p-8 text-center shadow-[0_20px_40px_rgba(10,109,255,0.06)] xl:grid-cols-[1fr_0.95fr] xl:items-center">
            <div>
              <SectionHeading
            ...
            <div className="rounded-[28px] border border-sky-100 bg-sky-50/70 p-6 text-center">
              <div className="mx-auto inline-flex rounded-2xl bg-brand-ocean/10 p-3 text-brand-ocean">
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="glow-button mt-6 inline-flex items-center justify-center gap-2 rounded-full px-5 py-4 text-sm font-semibold"
              >
